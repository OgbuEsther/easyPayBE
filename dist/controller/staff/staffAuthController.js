...
const staffSignup = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const getAdmin = yield adminAuth_1.default.findById(req.params.id);
        ...
        const staff = yield staffAuth_1.default.create({
            ...
            companyname: getAdmin === null || getAdmin === void 0 ? void 0 : getAdmin.companyname,
            email,
            yourName,
            password: hash,
            position,
        ...
        if ((getAdmin === null || getAdmin === void 0 ? void 0 : getAdmin.companyCode) === (staff === null || staff === void 0 ? void 0 : staff.companyCode)) {
